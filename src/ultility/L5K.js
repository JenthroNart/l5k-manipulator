...
const parseL5K = input => {
    ...
    try {
        ...
        //get programs
        set(parsedData, [L5K_Component.Program, 'items'], getL5K_Component(parsedInput, L5K_Component.Program))
        parsedData[L5K_Component.Program]['verbose_name'] = 'Programs'
        parsedInput = removeComponents(parsedData[L5K_Component.Program], parsedInput)
        const parsedPrograms = map(parsedData[L5K_Component.Program].items, program => Object.assign(program, parseL5KProgram(program.content)))
        parsedData[L5K_Component.Program].items = parsedPrograms

        //get Add On Instructions
        set(parsedData, [L5K_Component.AddOnInstruction, 'items'], getL5K_Component(parsedInput, L5K_Component.AddOnInstruction))
        parsedInput = removeComponents(parsedData[L5K_Component.AddOnInstruction], parsedInput)
        parsedData[L5K_Component.AddOnInstruction]['verbose_name'] = 'AOI'


        //get Modules
        set(parsedData, [L5K_Component.Module, 'items'], getL5K_Component(parsedInput, L5K_Component.Module))
        parsedData[L5K_Component.Module]['verbose_name'] = 'Modules'
        parsedInput = removeComponents(parsedData[L5K_Component.Module], parsedInput)


        //get Tasks
        set(parsedData, [L5K_Component.Task, 'items'], getL5K_Component(parsedInput, L5K_Component.Task))
        parsedData[L5K_Component.Task]['verbose_name'] = 'Tasks'
        parsedInput = removeComponents(parsedData[L5K_Component.Task], parsedInput)


        //get Configs
        set(parsedData, [L5K_Component.Config, 'items'], getL5K_Component(parsedInput, L5K_Component.Config))
        parsedData[L5K_Component.Config]['verbose_name'] = 'Configuration'
        parsedInput = removeComponents(parsedData[L5K_Component.Config], parsedInput)


        //get Trends
        set(parsedData, [L5K_Component.Trend, 'items'], getL5K_Component(parsedInput, L5K_Component.Trend))
        parsedData[L5K_Component.Trend]['verbose_name'] = 'Trends'
        parsedInput = removeComponents(parsedData[L5K_Component.Trend], parsedInput)


        //get Quick Watches
        set(parsedData, [L5K_Component.QuickWatch, 'items'], getL5K_Component(parsedInput, L5K_Component.QuickWatch))
        parsedData[L5K_Component.QuickWatch]['verbose_name'] = 'Quick Watches'
        parsedInput = removeComponents(parsedData[L5K_Component.QuickWatch], parsedInput)


        //get data types
        set(parsedData, [L5K_Component.DataType, 'items'], getL5K_Component(parsedInput, L5K_Component.DataType))
        parsedData[L5K_Component.DataType]['verbose_name'] = 'UDT'
        parsedInput = removeComponents(parsedData[L5K_Component.DataType], parsedInput)


        //get controller Scope Tags
        set(parsedData, [L5K_Component.Tag, 'items'], getL5K_Component(parsedInput, L5K_Component.Tag))
        ...
        if (parsedData[L5K_Component.Tag].items.length > 0) {
            parsedData[L5K_Component.Tag].items = parseTagComponent(parsedData[L5K_Component.Tag].items[0].content)
        }

        //get Controller Info
        set(parsedData, [L5K_Component.Controller, 'items'], getL5K_Component(parsedInput, L5K_Component.Controller))
        parsedInput = removeComponents(parsedData[L5K_Component.Controller], parsedInput)
        //get Routines

        set(parsedData, [L5K_Component.Routine, 'items'], getL5K_Component(parsedInput, L5K_Component.Routine))
        parsedData[L5K_Component.Routine]['verbose_name'] = 'Routines'
        parsedInput = removeComponents(parsedData[L5K_Component.Routine], parsedInput)

        //get FBD Routines
        set(parsedData, [L5K_Component.FBD_Routine, 'items'], getL5K_Component(parsedInput, L5K_Component.FBD_Routine))
        parsedData[L5K_Component.FBD_Routine]['verbose_name'] = 'FBD'
        parsedInput = removeComponents(parsedData[L5K_Component.FBD_Routine], parsedInput)

        //get ST Routines
        set(parsedData, [L5K_Component.ST_Routine, 'items'], getL5K_Component(parsedInput, L5K_Component.ST_Routine))
        parsedData[L5K_Component.ST_Routine]['verbose_name'] = 'ST'
        parsedInput = removeComponents(parsedData[L5K_Component.ST_Routine], parsedInput)

        //get SFC Routines
        set(parsedData, [L5K_Component.SFC_Routine, 'items'], getL5K_Component(parsedInput, L5K_Component.SFC_Routine))
        parsedData[L5K_Component.SFC_Routine]['verbose_name'] = 'SFC'
        parsedInput = removeComponents(parsedData[L5K_Component.SFC_Routine], parsedInput)
...
const getL5K_Component = (input, component) => {
    ...
    const constraints = "[\\s\\b]+" + component + "[^]*?[\\s\\b]+END_" + component + "[\\s\\b]";
